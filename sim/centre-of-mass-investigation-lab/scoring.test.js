...
const earlyReview=P.makeReview(P.enterCheck(P.initial(3)));assert.ok(earlyReview&&P.validate(earlyReview,true),"an unfinished attempt can be submitted as a valid frozen review");assert.equal(S.score(earlyReview).score,0,"an unfinished zero-evidence submission scores zero");
