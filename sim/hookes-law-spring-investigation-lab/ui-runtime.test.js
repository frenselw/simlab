...
assert.match(source, /mathLength\(extensionM, 2\)/);
assert.match(source, /toFixed\(2\), class: "math-number"/);
...
assert.equal(App.PREDICTION_SNAP_STEP_M, 0.0005, "prediction snapping supports 0.05 cm increments");
assert.equal(App.snapPredictionValue(0.03749), 0.0375, "prediction snapping can represent 3.75 cm");
