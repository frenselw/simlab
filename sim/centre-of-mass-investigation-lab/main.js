(function (root, factory) {
  ...
  function boot(options = {}) {
    ...
    function renderPart2(visualsOnly = false) {
      const defs=svgEl("defs"),arrowhead=svgEl("marker",{id:"part2-rotate-arrowhead",viewBox:"0 0 10 10",refX:8.5,refY:5,markerWidth:10,markerHeight:10,markerUnits:"userSpaceOnUse",orient:"auto"});arrowhead.append(svgEl("path",{d:"M0 0 L10 5 L0 10 Z",fill:"#1d4ed8"}));defs.append(arrowhead);
      ...
      handleWorld=safeHandlePoint();dom.svg.append(svgEl("path",{d:`M${handleWorld.x-14} ${handleWorld.y+11} A18 18 0 1 1 ${handleWorld.x+14} ${handleWorld.y-11}`,fill:"none",stroke:"#1d4ed8","stroke-width":3.5,"stroke-linecap":"round","marker-end":"url(#part2-rotate-arrowhead)","data-scene":"rotate-arrow"}));
      if (visualsOnly) return;
