...
assert.match(source, /function modelRecordMessage\(springKey, hadPredictions, hadDesign\)/);
...
assert.match(source, /target\.setAttribute\("aria-valuetext", label\)/);
...
assert.match(source, /安全上限/);
assert.match(source, /按你的模型預測的末端/);
