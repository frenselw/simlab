(function (root, factory) {
  ...
  function validProgress(segments, currentSegment, phase, totalArrow, totalAnswers) {
    const hasSecondSegmentData = segments[1].reached || segments[1].routeDistance > 0 || segments[1].coverage.length || segments[1].arrow || segments[1].answers;
    ...
    if (phase !== "draw-total" && segments[currentSegment].answers) return false;
