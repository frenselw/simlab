...
18. 清除改為單次操作、空白時停用並可用「復原上一步」取回；作圖期間不提供答案正確性檢查，只在已有圖線未覆蓋左右端或中間有明顯斷口時，於圖板角落以琥珀色低干擾標籤顯示「圖線未畫完」，而且不阻止提交；
...
5. 作圖期間不設答案檢查按鈕；圖線未覆蓋左右端或中間有明顯斷口時，圖板角落顯示琥珀色「圖線未畫完」完整度提示；
6. 在提交前回到任何一幅圖修改；
...
- 空白圖不顯示多餘提示；
- 已開始作圖但未延伸到左右端，圖板右上角以琥珀色標籤顯示「圖線未畫完」；
