(function (root, factory) {
  ...
  function boot(options = {}) {
    ...
    function renderPart3() {
      ...
      dom.solidSummary.textContent = observationReady ? `${problem.part3.type === "sphere" ? "均勻球體" : problem.part3.type === "cube" ? "均勻正方體" : "均勻長方體"}；你已完成一次觀察，現在可以按立體內的候選點判斷重心；亦可繼續轉動觀察。` : `${problem.part3.type === "sphere" ? "均勻球體" : problem.part3.type === "cube" ? "均勻正方體" : "均勻長方體"}；請先拖動立體，從不同方向觀察。完成一次明顯旋轉後，才可按候選點。`;
