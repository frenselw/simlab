...
assert.doesNotMatch(html, /id="debugPanel"|id="debugCompleteInvestigation"|id="debugCompleteModel"|開發調試|自動完成第一階段|自動完成第二階段/);
...
assert.doesNotMatch(source, /debugQueryEnabled|completeInvestigationForDebug|completeModelForDebug|debugAvailable|debugEnabled|調試模式|調試自動/);
...
assert.doesNotMatch(css, /\.debug-toggle|\.debug-panel/);
