(function (root, factory) {
  ...
  function boot(options = {}) {
    ...
    function renderPart1(visualsOnly = false) {
      ...
      apparatus.append(svgEl("ellipse",{cx:350,cy:258,rx:265,ry:8,fill:"#0f172a",opacity:".08"}),svgEl("rect",{x:80,y:215,width:540,height:24,rx:12,fill:"url(#rod)"}));
      ...
      dom.svg.append(svgEl("path",{d:`M${x-18} 338 L${x-4} ${rodBottom+1} Q${x} ${rodBottom-1} ${x+4} ${rodBottom+1} L${x+18} 338Z`,fill:"#64748b"}),svgEl("rect",{x:x-28,y:338,width:56,height:7,rx:3.5,fill:"#475569"}));
