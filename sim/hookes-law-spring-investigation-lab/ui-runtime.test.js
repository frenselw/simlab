...
assert.match(source, /function dependencyIssue\(generator, model, animation, scoring, persistence\)/);
assert.match(source, /function createBootstrapFailureApi\(\)/);
...
assert.match(html, /data-edit-phase="model">修改模型/);
assert.doesNotMatch(source, /原長基準/);
assert.match(source, /對應原長/);
