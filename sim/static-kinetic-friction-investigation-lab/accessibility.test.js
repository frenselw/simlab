...
for (const id of ["zeroTask", "zeroFrictionType", "zeroFrictionDirection", "zeroFrictionMagnitude", "staticTask", "staticPullPrompt", "breakawayTask", "breakawayPull", "breakawayAnswer"]) assert.match(html, new RegExp(`id="${id}"`));
